        ...
        <el-table-column align="center" label="选项">
          <template slot-scope="scope">
            <div class="custom-operation">
              <el-radio v-model="scope.row.result" :label="1">非常重要</el-radio>
              <el-radio v-model="scope.row.result" :label="2">很重要</el-radio>
              <el-radio v-model="scope.row.result" :label="3">一般</el-radio>
              <el-radio v-model="scope.row.result" :label="4">不太重要</el-radio>
              <el-radio v-model="scope.row.result" :label="5">非常不重要</el-radio>
            </div>
          </template>
        </el-table-column>
      </el-table>
...
import { submitIndexSurvey } from '@/api/survey'
